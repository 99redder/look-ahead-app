...
if (taskList) {
  taskList.addEventListener('click', async (e) => {
    ...
    try {
      ...
      const scrollPos = document.querySelector(".rolling-grid").scrollTop; console.log("scrollPos:", scrollPos);
      await loadTasks();
      document.querySelector(".rolling-grid").scrollTop = scrollPos; console.log("scrolled to:", scrollPos);
    } catch (err) {
